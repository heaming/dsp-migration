package com.ad.migration.domain.recentad.campaign;
...
public class RecentCampaign implements MigratedEntity {
    ...
    private RecentCampaign(Long id, String name, Long userId, Long budget, String linkUrl, LocalDateTime createdAt, LocalDateTime updatedAt, LocalDateTime deletedAt, LocalDateTime migratedAt) {
        this.id = id;
        this.name = name;
        this.userId = userId;
        this.budget = budget;
